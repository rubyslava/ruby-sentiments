...
As this can be really inspiring, we believe that the real fun comes, when the original task has to be extended or changed a lot or something unexpected has to be added :).
...
Lets build an "events calendar" app. Users will be able to sign to an event from a list. In details:
